export CUSTOM_SECURIY_ROLE=orca_storage_editor_997
export DEVSHELL_PROJECT_ID=qwiklabs-gcp-02-24950cb9ec0c
export SERVICE_ACCOUNT=orca-private-cluster-295-sa
export CLUSTER_NAME=orca-cluster-472
