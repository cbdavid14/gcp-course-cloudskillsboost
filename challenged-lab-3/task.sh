...
export IAP_NETWORK_TAG=allow-ssh-iap-ingress-ql-969

export INTERNAL_NETWORK_TAG=allow-ssh-internal-ingress-ql-969

export HTTP_NETWORK_TAG=allow-http-ingress-ql-969
